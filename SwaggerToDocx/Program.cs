                    ...
                    foreach (var met in methods)
                    {
                        ...
                        if (paramQuery?.Count > 0)
                        {
                            ...
                            for (int i = 0; i < paramQuery.Count; i++)
                            {
                                ...
                                workSheet.Cells[row, 4].Style.Border.BorderAround(ExcelBorderStyle.Thin);
                                workSheet.Cells[row, 4].Value = string.IsNullOrWhiteSpace(parameter.Format)
                                    ? $"{parameter.Type}"
                        ...
                        if (paramBody != null)
                        {
                            ...
                            if (paramBody.Schema != null)
                            {
                                ...
                                {
                                    schema =
                                        (JsonConvert.DeserializeObject<Dictionary<string, string>>(paramBody
                                            .Schema["items"].ToString())["ref"]).Replace("#/definitions/", "");
                                }
                                ...
                                if (document.Definitions.ContainsKey(schema))
                                {
                                    ...
                                    foreach (var property in modelInput.Properties)
                                    {
                                        ...
                                        workSheet.Cells[row, 2, row, 3].Style.Border
                                            .BorderAround(ExcelBorderStyle.Thin);
                                        workSheet.Cells[row, 2, row, 3].Merge = true;
                                        workSheet.Cells[row, 2, row, 3].Value = property.Key;

                                        workSheet.Cells[row, 4].Style.Border.BorderAround(ExcelBorderStyle.Thin);
                                        workSheet.Cells[row, 4].Value = string.IsNullOrWhiteSpace(property.Value.Format)
                                            ? $"{property.Value.Type}"
                                            : $"{property.Value.Type} ({property.Value.Format})";
                                        ...
                                        workSheet.Cells[row, 6].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                                        if (modelInput.Required != null &&
                                            modelInput.Required.Any(x => x == property.Key))
                                        {
                                            workSheet.Cells[row, 6].Value = "x";
                                        }
                                    ...
                                    workSheet.Cells[row, 3, row, 6].Style.Fill.BackgroundColor
                                        .SetColor(1, 244, 176, 132);
                                    workSheet.Cells[row, 3, row, 6].Value =
                                        DefinitionToJson(document.Definitions, modelInput);
                                    row++;
                                }
                            }
                        ...
                        if (response != null && response.Schema != null)
                        {
                            ...
                            if (response.Schema.ContainsKey("ref"))
                            {
                                ...
                                workSheet.Cells[row, 2, row, 3].Style.Font.Bold = true;
                                workSheet.Cells[row, 2, row, 3].Merge = true;
                                workSheet.Cells[row, 2, row, 3].Style.HorizontalAlignment =
                                    ExcelHorizontalAlignment.Center;
                                workSheet.Cells[row, 2, row, 3].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                                workSheet.Cells[row, 2, row, 3].Value = "Field";
                                workSheet.Cells[row, 4].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                ...
                                workSheet.Cells[row, 5, row, 5].Style.HorizontalAlignment =
                                    ExcelHorizontalAlignment.Center;
                                ...
                                var modelOutput = GetDefinition(document.Definitions,
                                    response.Schema["ref"].ToString());
                                ...
                                foreach (var item in modelOutput.Properties)
                                {
                                    ...
                                    workSheet.Cells[row, 4].Style.Border.BorderAround(ExcelBorderStyle.Thin);
                                    workSheet.Cells[row, 4].Value = string.IsNullOrWhiteSpace(item.Value.Format)
                                        ? $"{item.Value.Type}"
                                        : $"{item.Value.Type} ({item.Value.Format})";
                                    ...
                                    if (item.Value.Type == "array")
                                    {
                                        if (item.Value.Items.ContainsKey("ref"))
                                        {
                                            ...
                                            {
                                                workSheet.Cells[row, 1].Style.Border
                                                    .BorderAround(ExcelBorderStyle.Thin);
                                                workSheet.Cells[row, 1].Value = index + 1;
                                                ...
                                                workSheet.Cells[row, 4].Style.Border
                                                    .BorderAround(ExcelBorderStyle.Thin);
                                                workSheet.Cells[row, 4].Value =
                                                    string.IsNullOrWhiteSpace(property.Value.Format)
                                                        ? $"{property.Value.Type}"
                                                        : $"{property.Value.Type} ({property.Value.Format})";

                                                workSheet.Cells[row, 5, row, 6].Style.Border
                                                    .BorderAround(ExcelBorderStyle.Thin);
                                    ...
                                    if (item.Value.Ref != null)
                                    {
                                        ...
                                        modelOutput.Properties[item.Key].Schema =
                                            referenceOutModel.Properties.ToDictionary(x => x.Key,
                                                x => (object) x.Value);
                            ...
                            else if (response.Schema.ContainsKey("type") &&
                                     response.Schema["type"].ToString() == "array")
                            {
                                row++;
                                workSheet.Cells[row, 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                workSheet.Cells[row, 1].Style.Fill.BackgroundColor.SetColor(1, 169, 208, 142);
                                ...
                                var typeResponse =
                                    JsonConvert.DeserializeObject<Dictionary<string, string>>(response.Schema["items"]
                                        .ToString())["ref"];
